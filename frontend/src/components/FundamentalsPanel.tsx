    ...
    <div className="card p-5">
      ...
      {data && !data.error ? (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6">
          <div>
            <p className="text-xxs font-bold mb-1" style={{ fontFamily: 'var(--font-sans)', color: 'rgb(var(--color-accent))' }}>VALUATION</p>
          ...
          <div>
            <p className="text-xxs font-bold mb-1" style={{ fontFamily: 'var(--font-sans)', color: 'rgb(var(--color-accent))' }}>PROFITABILITY</p>
          ...
          <div>
            <p className="text-xxs font-bold mb-1" style={{ fontFamily: 'var(--font-sans)', color: 'rgb(var(--color-accent))' }}>HEALTH</p>
          ...
          <div>
            <p className="text-xxs font-bold mb-1" style={{ fontFamily: 'var(--font-sans)', color: 'rgb(var(--color-accent))' }}>ANALYSTS</p>
